...
|---|-------|----------|---------|-----------------|--------------|
| 01 | Coronarography Stenosis | EN | Edith, elderly female | Moderate stenosis LAD + RCA, exertional dyspnea | Coronarography scheduled, Crestor + Asaflow prescribed, LDL 75 too high with existing plaques, fibromyalgia comorbidity, family history (mother: cerebral hemorrhage, sister: aneurysm at 58) |
...
| 04 | Chest Pain Carotid | EN | Mrs. Kurszyma, female | Chest pain post-surgery, carotid plaques | Belsar 10mg, BMI 35 (grade 2 obesity), no smoking, referral for vascular CT scan, cholesterol testing needed, prior cardiologist records missing from system |
