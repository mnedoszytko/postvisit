    ...
    <div class="max-w-2xl mx-auto px-4 py-12">
      ...
      <div v-if="page === 'privacy'" class="prose prose-gray max-w-none space-y-6">
        ...
        <section>
          ...
          <ul class="text-gray-600 space-y-2 list-disc pl-5">
            <li><strong>Account Information:</strong> Name, email address, and date of birth used to create your account.</li>
            ...
            <li><strong>Usage Data:</strong> Anonymous analytics about feature usage to improve the service.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p class="text-gray-600 leading-relaxed">Your health data is processed by Claude (Anthropic) to generate summaries, answer questions, and create educational content. Data sent to the AI is not used to train models. All AI interactions are logged for quality assurance and audit purposes.</p>
        </section>
        ...
        <section>
          ...
          <p class="text-gray-600 leading-relaxed">Your health data is retained for as long as your account is active. Audio recordings are processed and may be deleted after transcription is complete. You may request deletion of your data at any time.</p>
        </section>

        <section>
          <h2 class="text-xl font-semibold text-gray-900">7. Your Rights</h2>
          <ul class="text-gray-600 space-y-2 list-disc pl-5">
            <li>Access and export your health data.</li>
            <li>Request correction of inaccurate information.</li>
            <li>Request deletion of your account and associated data.</li>
            <li>Withdraw consent for audio recording at any time.</li>
          </ul>
        </section>
      ...
      <div v-else-if="page === 'terms'" class="prose prose-gray max-w-none space-y-6">
        ...
        <section>
          ...
          <p class="text-gray-600 leading-relaxed">Summaries, explanations, and educational materials are generated by AI and may contain errors. We provide medical references and citations where possible, but accuracy is not guaranteed. All AI outputs include evidence-based references sourced from PubMed and clinical guidelines.</p>
        </section>
      ...
      <div v-else-if="page === 'legal'" class="prose prose-gray max-w-none space-y-6">
        ...
        <section>
          ...
          <ul class="text-gray-600 space-y-2 list-disc pl-5">
            <li><strong>Drug Information:</strong> RxNorm (NLM/NIH) and DailyMed (FDA) — public domain.</li>
            <li><strong>Medical References:</strong> PubMed/MEDLINE (NLM/NIH) — citation metadata under NLM's terms.</li>
            <li><strong>Clinical Terminology:</strong> SNOMED CT, ICD-10 — used under applicable licenses.</li>
          </ul>
        </section>
